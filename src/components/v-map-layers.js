...
const SERVER_URL = 'https://msfd.avi.deltares.nl/thredds/wms/Thredds/'
...
export default {
  ...
  methods: {
    ...
    makeBoxPlot (filename, lat, lon) {
      $.ajax({url: 'https://msfd.avi.deltares.nl/thredds/ncss/grid/Thredds/' + this.selectPeriod + '/' + filename + '.nc?var=P10_chlorophyll&var=P25_chlorophyll&var=P50_chlorophyll&var=P75_chlorophyll&var=P90_chlorophyll&latitude=' + lat + '&longitude=' + lon + '&accept=csv',
        async: false,
